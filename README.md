...
<details>
  ...
  - Use o comando: `git clone git@github.com:tryber/csharp-029-csharp-projeto-trybe-hotel-fase-d.git`.
  - Entre na pasta do repositório que você acabou de clonar:
    - `cd csharp-029-csharp-projeto-trybe-hotel-fase-d`
  ...
  - Agora crie uma branch à qual você vai submeter os `commits` do seu projeto
    ...
    - Exemplo: `git checkout -b joaozinho-csharp-029-csharp-projeto-trybe-hotel-fase-d`
  ...
  - Usando o exemplo anterior: `git push -u origin joaozinho-csharp-029-csharp-projeto-trybe-hotel-fase-d`

  6. Crie um novo `Pull Request` _(PR)_

  - Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/csharp-029-csharp-projeto-trybe-hotel-fase-d/pulls)
...
<details>
  ...
  - Vá até a página **DO SEU** _Pull Request_, adicione a label de _"code-review"_ e marque seus colegas:
    ...
    - No menu à direita, clique no _link_ **"Reviewers"** e digite `students`, selecione o time `tryber/students-sd-029-csharp`.
...
[FORMULÁRIO DE AVALIAÇÃO DE PROJETO](https://be-trybe.typeform.com/to/ZTeR4IbH#cohort_hidden=CH29-CSHARP&template=betrybe/csharp-0x-projeto-trybe-hotel-fase-d)
